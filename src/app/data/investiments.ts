...
export const investiments: Accordion = {
	...
	{
		title: 'Spaceship',
		data: `São 3 fundos de investimentos que você pode escolher: Universe, Index e o Superannuation, os dois primeiros com investimento inicial e aportes a partir de $5 dólares. <br><br>
		<ul><li>O Universe é composto de 100 empresas de alto crescimento ao redor do mundo, maioria delas são de tecnologia e tem empresas como Google, Apple, Amazon e Tesla. As empresas escolhidas seguem uma metodologia criada por eles e pode ver a analise da cada escolha no site.</li><br>
